...
Tarih: 2026-07-28 20:22 UTC
IMAJER sürümü: `0.3.0`
Sonuç: **BAŞARILI**

## Test kapsamı

Docker içindeki Alpine Linux hedefi gerçek TCP, SSH ve SFTP üzerinden
kullanıldı. Controller macOS arm64 üzerinde, agent Linux arm64 üzerinde native
çalıştı. Test fiziksel disk yerine hedefteki salt-okunur 24 MiB sentetik RAW
dosyasını kullandı.
...
10. Uzak geçici agent ve staging kalıntısı kontrolü
11. Kanıt paketinde private key/credential kalıbı taraması

## Sonuç değerleri

- Hedef: Alpine 3.22, Linux `6.12.76-linuxkit`, arm64
...
Test container'ını durdurmak için:
...
- TCP/SSH bağlantısını chunk ortasında kesip `resume` doğrulaması
- Linux amd64 hedef
